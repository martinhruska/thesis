...
The procedure continues with first folding.
...
When this pattern is folded to a box named $\mathtt{dls}$ and the corresponding parts of automaton are replaced by the box.
