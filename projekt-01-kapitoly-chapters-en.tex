...
of selector names.
	  ...
	  The scalability of the approach based on separation logic was significantly improved by bi-abduction \cite{abduction09}.
	  ...
	  were used in~\cite{soa-pldi07synthesis}.
	  ...
	  \subsection{Automated Decision Procedure}
          ...
          satisfiability and entailment---see, e.g., \cite{soa-EneaLSV14, soa-IRV14,
...
logic (SL)~\cite{Reynolds:SepLogic:02,berdine07cav,rival07} such as symbolic memory
