...
Moreover, since we use finite automata to model communication
we are able to make an abstraction over learnt models and extrapolate the new test
...
of selector names.
	...
	However, the undecidability of logic implies that automata accepting such graphs would have undecidable
...
safe (from perspective of memory safety) by Predator executed in overapproaximating (sound) mode.
