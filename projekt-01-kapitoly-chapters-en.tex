...
Then the futher development extended the set of programs verified only by \forester.
...
As we already dicussed, the main weaknesses of \forester came from that it is still a technical immature of the tool.
...
We start with an intution and later formalise the described method.
...
For simplicity we present a generation of scenario corresponding directly to the collected logs without any abstraction inlcuded.
