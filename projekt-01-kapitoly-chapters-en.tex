...
Software quality is a crucial part of development cycles
...
The main negatives are the high demands on qualification of developers and an inability to scale
to larger software.

There are also automated approaches to proving correctness of program such as
model checking or automated theorem proving which strive to verify a program according to given specification.
...
The lightweighted versions of this kind of methods are different types of sound static analysis or
abstract intepretation which are specialized to a certain program properties
(such as values of integer variables, or analyses for termination properties).
...
As we mentioned above, language of finite automaton (or its variant) represent
...
languages with manual memory management as C or C++ what makes situation even worse.
...
and a rest of manufactory emulated.
...
First, an overview of the formalisms for representing data structures allocated on heap is given.
...
allocated on the heap by a program.
