...
The tools competing in SV-COMP varies from sound abstract interpreters or formal verifiers through static analysers
...
E.g., in reachability category there is checked whether a certain line of program is reached.
...
The backward run starts with forest automaton representing state of heap in state where the violation was found.
...
This made reporting of found bugs program reliable and avoid unnecessary false alarms.
...
The second result in shape analysis are mupltiple participations of the Forester
