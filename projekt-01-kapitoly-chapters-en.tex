...
We use the both formalisms to represent actual state of heap, i.e., dynamic data structures actually allocated on heap.
...
We aim to development of existing approach to shape analysis based on forest automata
and its improvement to enable verification of largel class of programs.
We also want to propose a new formalism which will be based on Courcelle theorem \cite{Courcelle}
...
Another part of this results is a participation of the tool Forester
