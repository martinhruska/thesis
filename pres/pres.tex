	...
	\begin{itemize}
		...
		\item \hlrd{Shape analysis}
	        \begin{itemize}
                ...
                \pause
		  \item Goal: \hlbl{Derive reachable shapes of dynamic data structures}.
...
\frame{\frametitle{Automata Theory in Shape Analysis}
	...
	\begin{itemize}
		...
		\item \hlbl{Generality} to represent various kinds of data structures.
	\end{itemize}
}
%*******************************************************************************
...
\frame{\frametitle{Towards Efficient Shape Analysis with Tree Automata (TA)}
	...
	\end{itemize}
        ...
        \item The new automata are based on tree automata but we work with single TA instead of tuple of TA (like in FA).  
        \end{itemize}
}
%*******************************************************************************
...
\frame{\frametitle{Tree Decomposition with Variables}
	...
	\end{itemize}
 	...
 	\end{center}
        ...
        \pause
	\begin{itemize}
        \item Two operations needed to transform one decomposition to another:
        \pause
	  \begin{itemize}
            \item \hlbl{Reconnection} - moving the node $b_0$ under the node $b_0'$.
            \item \hlbl{Rotation} - changing orientation of the edges between two nodes.
	  \end{itemize}
	\end{itemize}
}
%*******************************************************************************
...
\frame{\frametitle{Towards Entailment}
	  \begin{itemize}
            ...
            \vspace{1em}
            \item<2-> The implementation of a \hlbl{tree automata phase at most doubles the number of variables} and leads to \hlbl{an automaton that is of a polynomial size assuming a fixed tree-width} of the original automaton.
            \vspace{1em}
...
\frame{\frametitle{Shape Analysis based on SMT Solving in 2LS Framework}
	\begin{itemize}
          ...
          \item Therefore more straightforward than the automata-based approaches, but lacks generality of automata based approaches.
          \pause
...
\caption{Comparison of 2LS with other tools on examples needing reasoning about unbounded data structures and their stored data.}
\vspace*{-1mm}
\label{tab:others}
\centering
\scriptsize
...
\frame{\frametitle{Introduction}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item This includes communication with information system, machines, etc.
      \item Difficult to test:
      \begin{itemize}
         \item Distributed nature of manufacturing, different communication protocols, different formats of structured data.
...
\frame{\frametitle{Our Solution}
\begin{itemize}
  \item Messages in different formant (XML, or JSON)\,---\,use format indepedent \hlbl{Trie} structure (prefix tree)
    \pause
  \item Representing communication using \hlbl{event calendar}.
  \begin{itemize}
    \item Direct generation of scenario for digital twin.
    \item Can be transformed to finite automaton\,---\,application of abstraction to overapproximate langauge.
  ...
  \begin{itemize}
    \item Generated valid scenarios for orchestration of digital twin with deployed Pharis. 
